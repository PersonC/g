...
//
	...
	public Zt(int f, int typeABC, int typeCR, Xy x0) {
		this.n = x0.n;
		this.m = x0.m;
		this.f = f;
		this.xy = x0;
...
//....................
	public double f_cr(double ax, double az, int j, int k) {
		double cr = 0, dd;
		for (int i = 0; i < n; i++) {
			if (xy.im[i][typeCR] == 1) {
...
//===========================================================
	public void toPrint(String s) {
		...
		for (int k = 0; k < f0; k++)
			System.out.println(toPrint(ir[k]));
	}
...
//..................................	
	public String toPrint(int k) {
		...
		return "f=" + k + ", zmin=" + zmin[k][typeABC] + ", zmax=" + zmax[k][typeABC] + ", zm=" + zm[k][typeABC]
				+ ", sum(z**2)=" + sz2[k][typeABC] + ", zy=" + yz[k][typeABC] + ", cr=" + r[k] + "\n" + s;
	}
...
//.............................................	
	public void toPrintCr() {
		...
		for (int k = 0; k < f2; k++) {
			s += "k=" + k + " cr=" + crm[k] + " ax[" + jx[k] + "]= " + a1[k] + " az[" + kz[k] + "]= " + a2[k] + "\n";
		}
		System.out.println(s);
	}
}
